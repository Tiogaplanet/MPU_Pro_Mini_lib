 ...
 */
void setup() {
  // Initialize MiP connection
  bool connectResult = mip.begin();

  if (!connectResult) {
    Serial.println(F("PersistentMemory: Failed connecting to MiP!"));
    return;
  }

  // Define test password as fixed-size char array to save RAM on ATmega328P
